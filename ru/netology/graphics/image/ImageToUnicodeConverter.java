...
public class ImageToUnicodeConverter implements TextGraphicsConverter {
    ...
    public ImageToUnicodeConverter() {
        schema = new UnicodeSchema('@', '%', '$', '#', '=', '/', '!', '.');
    }

    public ImageToUnicodeConverter(char... charSet) {
        schema = new UnicodeSchema(charSet);
    }

    public ImageToUnicodeConverter(int maxRatio, char... charSet) {
        this.maxRatio = maxRatio;
        schema = new UnicodeSchema(charSet);
    }

    public ImageToUnicodeConverter(int maxRatio, int maxWidth, char... charSet) {
        this.maxRatio = maxRatio;
        this.maxWidth = maxWidth;
        schema = new UnicodeSchema(charSet);
    }

    public ImageToUnicodeConverter(int maxRatio, int maxWidth, int maxHeight, char... charSet) {
        this.maxRatio = maxRatio;
        this.maxWidth = maxWidth;
    ...
    public String convert(String url) throws IOException, BadImageSizeException {
        ...
        if ((maxWidth != 0) && (maxHeight != 0)) {
            ...
            if (scaleH > scaleW) {
                newHeight = (int) (height * scaleW);
                newWidth = (int) (width * scaleW);
            } else {
                newHeight = (int) (height * scaleH);
                newWidth = (int) (width * scaleH);
            }
